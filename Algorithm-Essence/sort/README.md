...
- [中位数和顺序统计量](./median-order-statistic.py)
...
排序算法的 [基类 Sort](./sort-base-class.py)。

排序算法类型 | 算法名称 | 时间-平均情况 | 时间-最好情况 | 时间-最坏情况 | 空间-辅助存储 | 稳定性
:-: | :-: | :-: | :-: | :-: | :-: | :-:
插入排序 | **[直接插入排序](./insertion-sort.py)** | O(n^2) | **O(n)** | O(n^2) | O(1) | 稳定
插入排序 | **[希尔排序](./shell-sort.py)** | **O(n^1.3)** | **O(n)** | O(n^2) | O(1) | 不稳定
...
选择排序 | **[堆排序](./heap-sort.py)** | **O(n log n)** | O(n log n) | O(n log n) | O(1) | 不稳定
选择排序 | **Smooth Sort** | O(n log n) | **O(n)** | O(n log n) | O(1) | 不稳定
交换排序 | **冒泡排序** | O(n^2) | O(n) | O(n^2) | O(1) | 稳定 | 
交换排序 | **[快速排序](./quick-sort.py)** | **O(n log n)** | O(n log n) | O(n^2) | O(log n) | 不稳定
归并排序 | **[二路归并排序](./merge-sort.py)** | **O(n log n)** | O(n log n) | O(n log n) | O(n) | 稳定
归并排序 | **Quad Sort** | O(n log n) | **O(n)** | O(n log n) | O(n) | 稳定
插入&归并 | **[Tim Sort](./tim-sort.py)** | O(n log n) | **O(n)** | O(n log n) | O(n) | 稳定
...
[线性时间排序](./linear-time-sort.py) | **桶排序** | O(n) | O(n) | O(n) | O(n) | 稳定
