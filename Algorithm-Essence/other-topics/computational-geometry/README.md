...
- [计算几何学](./computational-geometry.py) Computational Geometry
	- 线段的性质
	- 确定任意一对线段是否相交
	- 寻找凸包
	- 寻找最近点对
...
![computational-geometry-1](./img/computational-geometry-1.png)

![computational-geometry-2](./img/computational-geometry-2.png)

### 1.1. 叉积

![computational-geometry-3](./img/computational-geometry-3.png)

事实上，二维向量的**叉积**是一个三维的概念。根据“右手法则”，它是一个与 p1 和 p2 都垂直的向量，其量值为 $| x_1 \cdot y_2 - x_2 \cdot y_1 |$。在这里，不考虑叉积作为一个向量的方向性，而仅考虑其模长。

### 1.2. 确定连续线段是向左转还是向右转

![computational-geometry-4](./img/computational-geometry-4.png)

![computational-geometry-5](./img/computational-geometry-5.png)
...
![computational-geometry-6](./img/computational-geometry-6.png)

![computational-geometry-7](./img/computational-geometry-7.png)

![computational-geometry-8](./img/computational-geometry-8.png)
...
![computational-geometry-9](./img/computational-geometry-9.png)

![computational-geometry-10](./img/computational-geometry-10.png)

## 2. 确定任意一对线段是否相交

![segment-intersect-1](./img/segment-intersect-1.png)

![segment-intersect-2](./img/segment-intersect-2.png)

### 2.1. 线段排序

![segment-intersect-3](./img/segment-intersect-3.png)

![segment-intersect-4](./img/segment-intersect-4.png)
...
![segment-intersect-5](./img/segment-intersect-5.png)
...
![segment-intersect-6](./img/segment-intersect-6.png)

### 2.4. 求线段交点算法的正确性

![segment-intersect-7](./img/segment-intersect-7.png)

![segment-intersect-8](./img/segment-intersect-8.png)

![segment-intersect-9](./img/segment-intersect-9.png)

### 2.5. 求线段交点算法的运行时间

![segment-intersect-10](./img/segment-intersect-10.png)

### 2.6. 其它线段相交相关问题与性质

![segment-intersect-11](./img/segment-intersect-11.png)

![segment-intersect-12](./img/segment-intersect-12.png)

## 3. 寻找凸包

![convex-hull-1](./img/convex-hull-1.png)

![convex-hull-2](./img/convex-hull-2.png)

因此，通过在 O(n log n) 时间内计算出 n 个输入点的凸包，然后再找出得到的凸多边形中的最远顶点对，就可以在 O(n log n) 时间内 找出任意 n 个点组成的集合中**距离最远的点对**。

### 3.1. Graham 扫描法

![convex-hull-3](./img/convex-hull-3.png)
...
![convex-hull-4](./img/convex-hull-4.png)

![convex-hull-5](./img/convex-hull-5.png)

![convex-hull-6](./img/convex-hull-6.png)

![convex-hull-7](./img/convex-hull-7.png)

![convex-hull-8](./img/convex-hull-8.png)

### 3.2. Jarvis 步进法

![convex-hull-9](./img/convex-hull-9.png)

![convex-hull-10](./img/convex-hull-10.png)

![convex-hull-11](./img/convex-hull-11.png)

### 3.3. 其它点集凸包相关问题与性质

![convex-hull-12](./img/convex-hull-12.png)

## 4. 寻找最近点对

![nearest-pair-1](./img/nearest-pair-1.png)

![nearest-pair-2](./img/nearest-pair-2.png)

### 4.1. 分治算法

![nearest-pair-3](./img/nearest-pair-3.png)

![nearest-pair-4](./img/nearest-pair-4.png)

### 4.2. 算法的正确性

![nearest-pair-5](./img/nearest-pair-5.png)

![nearest-pair-6](./img/nearest-pair-6.png)

![nearest-pair-7](./img/nearest-pair-7.png)

### 4.3. 算法的实现与运行时间分析

![nearest-pair-8](./img/nearest-pair-8.png)
...
![nearest-pair-9](./img/nearest-pair-9.png)

### 4.4. 其它最近点对相关问题与性质

![nearest-pair-10](./img/nearest-pair-10.png)

## 5. 其它计算几何学相关问题

### 5.1. 凸层

![cg-other-questions-1](./img/cg-other-questions-1.png)

### 5.2. 最大层

![cg-other-questions-2](./img/cg-other-questions-2.png)

### 5.3. 巨人和鬼问题

![cg-other-questions-3](./img/cg-other-questions-3.png)

### 5.4. 拾取棍子问题

![cg-other-questions-4](./img/cg-other-questions-4.png)

### 5.5. 稀疏包分布

![cg-other-questions-5](./img/cg-other-questions-5.png)

![cg-other-questions-6](./img/cg-other-questions-6.png)
