...
- [多项式与快速傅立叶变换](./fast-fourier-transform.py) Polynomial & FFT
...
![dft-fft-1](./img/dft-fft-1.png)

![dft-fft-2](./img/dft-fft-2.png)

### 离散傅立叶变换 DFT

![dft-fft-3](./img/dft-fft-3.png)

### 快速傅立叶变换 FFT

FFT 加速的核心思想就是利用**分治策略**，同时也利用了类似**快速幂**的技术。

![dft-fft-4](./img/dft-fft-4.png)
...
![dft-fft-5](./img/dft-fft-5.png)

### 在单位复数根处插值

插值是把一个多项式从(DFT)点值表达形式转换回系数表达形式。插值思路：把 DFT 写成一个矩阵方程，然后再观察其逆矩阵的形式。

![dft-fft-6](./img/dft-fft-6.png)

![dft-fft-7](./img/dft-fft-7.png)
...
![dft-fft-8](./img/dft-fft-8.png)

![dft-fft-9](./img/dft-fft-9.png)
...
![dft-fft-12](./img/dft-fft-12.png)

## 并行 FFT 电路

![dft-fft-13](./img/dft-fft-13.png)

![dft-fft-14](./img/dft-fft-14.png)
